...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2020 at 04:49 PM
...
--
-- Dumping data for table `agen_ekspedisi`
--

INSERT INTO `agen_ekspedisi` (`id_agen_ekspedisi`, `nama`, `alamat`, `city_id`, `state_id`, `country_id`, `telepon`, `email`, `fax`, `chat`, `id_users`) VALUES
...
INSERT INTO `bahasa` (`id_bahasa`, `nama_bahasa`, `id_users`) VALUES
...
INSERT INTO `barang` (`id_barang`, `kode_barang`, `nama_barang`, `merek_brand`, `model_type`, `berat_bruto`, `ukuran_volume`, `warna`, `id_kategori`, `id_subkategori`, `id_rak`, `harga_beli`, `jml_minimal`, `jml_maksimal`, `stok`, `ppn`, `kode_satuan`, `keterangan_barang`, `foto_barang`, `status_jual`, `id_users`, `waktu_input`) VALUES
(1, 'BRG-000001', 'Sabun Mandi Batangan', 'Lifebuoy', 'Cair', 0.1, '10cm x 10 cm', 'putih', 1, 0, 2, 3000, 5, 200, 15, 10, 'lsn', 'Tuliskan Keterangan Disini,..', 'sabun.png', 'ya', 1, '2018-05-23 08:24:51'),
...
INSERT INTO `barang_harga` (`id_barang_harga`, `id_barang`, `id_kategori_pelanggan`, `id_jenis_jual`, `harga`, `persen_beli`, `diskon`, `jumlah`, `satuan`) VALUES
...
--
-- Table structure for table `barang_jenis_jual`
--

CREATE TABLE `barang_jenis_jual` (
  `id_barang_jenis_jual` int(11) NOT NULL,
  `nama_jenis_jual` varchar(50) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `barang_jenis_jual`
--

INSERT INTO `barang_jenis_jual` (`id_barang_jenis_jual`, `nama_jenis_jual`) VALUES
(1, 'Ritel'),
(2, 'Grosir 1'),
(3, 'Grosir 2'),
(4, 'Grosir 3');
...
--
-- Table structure for table `bebanbiaya_list`
--

CREATE TABLE `bebanbiaya_list` (
...
--
-- Dumping data for table `bebanbiaya_list`
--

INSERT INTO `bebanbiaya_list` (`id_bebanbiaya_list`, `id_bebanbiaya_sub`, `tanggal`, `jumlah_uang`, `keterangan`, `id_karyawan`, `waktu_proses`) VALUES
...
--
-- Table structure for table `bebanbiaya_main`
--

CREATE TABLE `bebanbiaya_main` (
  `id_bebanbiaya_main` int(11) NOT NULL,
  `nama_bebanbiaya_main` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `bebanbiaya_main`
--

INSERT INTO `bebanbiaya_main` (`id_bebanbiaya_main`, `nama_bebanbiaya_main`) VALUES
...
--
-- Table structure for table `bebanbiaya_sub`
--

CREATE TABLE `bebanbiaya_sub` (
  `id_bebanbiaya_sub` int(11) NOT NULL,
  `id_bebanbiaya_main` int(11) NOT NULL,
...
--
-- Dumping data for table `bebanbiaya_sub`
--

INSERT INTO `bebanbiaya_sub` (`id_bebanbiaya_sub`, `id_bebanbiaya_main`, `nama_bebanbiaya_sub`) VALUES
...
INSERT INTO `city` (`city_id`, `state_id`, `name`, `id_users`) VALUES
(1, 1, 'Badung', 1),
(2, 1, 'Bangli', 1),
(3, 1, 'Buleleng', 1),
(4, 1, 'Gianyar', 1),
...
--
-- Table structure for table `conf_barang`
--

CREATE TABLE `conf_barang` (
...
--
-- Dumping data for table `conf_barang`
--

INSERT INTO `conf_barang` (`id_conf_barang`, `kode_barang`, `harga_grosir`, `grosir_berdasarkan`, `harga_kategori_pelanggan`, `kode_satuan`, `konversi_satuan_beli`, `sertakan_gambar`) VALUES
(1, 'default', 'visible', 'multi_satuan', 'visible', 'bh', 'visible', 'visible');

-- --------------------------------------------------------

--
-- Table structure for table `conf_penjualan`
--

CREATE TABLE `conf_penjualan` (
...
--
-- Table structure for table `conf_perusahaan`
--

CREATE TABLE `conf_perusahaan` (
...
--
-- Dumping data for table `conf_perusahaan`
--

INSERT INTO `conf_perusahaan` (`id_perusahaan`, `nama_perusahaan`, `npwp_perusahaan`, `alamat_perusahaan`, `city_id`, `state_id`, `country_id`, `telepon`, `email`, `fax`, `website`, `kode_pos`, `logo`) VALUES
(1, 'Toko Coding', 'NPWP-452123', 'Jl. Kebagusan Raya', 371, 31, 1, '0853', '401xdssh@gmail.com', '0751461691', 'mycoding.net', 26125, 'logo.png');
...
INSERT INTO `country` (`country_id`, `name`, `id_users`) VALUES
(1, 'Indonesia', 1),
(2, 'Inggris', 1),
(3, 'Malaysia', 1);
...
INSERT INTO `departemen` (`id_departemen`, `nama_departemen`, `keterangan`, `id_users`) VALUES
...
INSERT INTO `jabatan` (`id_jabatan`, `nama_jabatan`, `keterangan`, `id_users`) VALUES
...
INSERT INTO `jatuh_tempo` (`id_jatuh_tempo`, `hari_jatuh_tempo`) VALUES
(1, '1'),
(2, '3'),
(3, '7'),
(4, '15'),
...
INSERT INTO `karyawan` (`id_karyawan`, `username`, `password`, `nik`, `nama_karyawan`, `id_jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `id_agama`, `id_status_pernikahan`, `alamat_karyawan_1`, `alamat_karyawan_2`, `city_id`, `state_id`, `country_id`, `telepon_karyawan`, `hp_karyawan`, `email_karyawan`, `website_karyawan`, `kode_pos_karyawan`, `fax_karyawan`, `chat_karyawan`, `keterangan`, `foto_karyawan`, `id_jabatan`, `id_departemen`, `tanggal_masuk`, `id_status_karyawan`, `aktif`, `id_users`, `waktu_daftar`) VALUES
(1, 'admin', '$2y$10$U5wuRSStr0kpCiPAijfvu.b3iEuWG16XPyDPMX4sc5PwoPisBcdbO', '202190144190', 'Admin ', 1, 'Jakarta', '1994-02-19', 1, 2, 'Jl. Raya', '', 367, 31, 1, '077702154', '0853', '401xdssh@gmail.com', 'https://admin.com', 56789, '077702145', '401xdssh@gmail.com', '', 'rob.jpg', 1, 2, '2016-02-12', 1, 'ya', 1, '2020-11-18 16:27:33');
...
INSERT INTO `kategori` (`id_kategori`, `nama_kategori`, `id_users`) VALUES
(1, 'Barang Panas', 1),
(2, 'Barang Dingin', 1);
...
INSERT INTO `kategori_pelanggan` (`id_kategori_pelanggan`, `nama_kategori_pelanggan`, `permanen`, `id_users`) VALUES
...
INSERT INTO `pelanggan` (`id_pelanggan`, `id_kategori_pelanggan`, `id_type_pelanggan`, `nama_pelanggan`, `kontak_pelanggan`, `alamat_pelanggan_1`, `alamat_pelanggan_2`, `city_id`, `state_id`, `country_id`, `telpon_pelanggan`, `hp_pelanggan`, `email_pelanggan`, `website_pelanggan`, `kode_pos_pelanggan`, `fax_pelanggan`, `chat_pelanggan`, `keterangan`, `id_users`, `waktu_daftar`) VALUES
(1, 1, 1, 'Sinta Safitri', '085716129917', 'Jln, Saruko Rayo Bamato', '', 373, 31, 1, '0751223311', '085263012000', 'dewitt.safitri@gmail.com', 'http://sinta.com', 45789, '0751220011', 'dewitt.safitri@yahoo.com', '', 1, '2016-12-31 09:13:22'),
(2, 2, 2, 'Ananda Orlando', '082173054500', 'Jln. Ulak Karang Raya', '', 373, 31, 1, '0751635899', '082365447899', 'arsenio@gmail.com', 'http://orlando.com', 45123, '0751567788', 'arsenio@yahoo.com', '', 1, '2016-12-31 06:24:12');

-- --------------------------------------------------------

--
-- Table structure for table `pelanggan_piutang`
--

CREATE TABLE `pelanggan_piutang` (
...
--
-- Dumping data for table `pelanggan_piutang`
--

INSERT INTO `pelanggan_piutang` (`id_pelanggan_piutang`, `id_pelanggan`, `batas_piutang`, `batas_frekuensi`) VALUES
(1, 2, 750000, 5);
...
INSERT INTO `pembelian` (`id_pembelian`, `kode_pembelian`, `tgl_kirim`, `id_karyawan`, `id_supplier`, `id_type_bayar`, `keterangan`, `tgl_pembelian`, `tgl_terima`, `referensi`, `kepada_attention`, `id_users`, `waktu_pembelian`) VALUES
...
INSERT INTO `pembelian_detail` (`id_pembelian_detail`, `id_pembelian`, `id_barang`, `jml_pesan`, `harga_pesan`) VALUES
(1, 1, 2, 5, 13000),
(2, 1, 3, 7, 6500),
(3, 1, 1, 3, 3000),
(4, 2, 1, 4, 3000),
...
--
-- Table structure for table `pembelian_return`
--

CREATE TABLE `pembelian_return` (
...
--
-- Dumping data for table `pembelian_return`
--

INSERT INTO `pembelian_return` (`id_pembelian_return`, `id_pembelian_terima`, `no_return`, `tgl_kirim_return`, `id_type_bayar`, `keterangan_return`, `tanggal_return`, `id_users`, `waktu_return`) VALUES
(1, 1, 'RET-001', '2017-02-14', 1, 'Sudah dibayarkan semua,..', '2017-02-14', 1, '2017-02-13 05:41:35');

-- --------------------------------------------------------

--
-- Table structure for table `pembelian_return_detail`
--

CREATE TABLE `pembelian_return_detail` (
...
--
-- Dumping data for table `pembelian_return_detail`
--

INSERT INTO `pembelian_return_detail` (`id_pembelian_return_detail`, `id_pembelian_return`, `id_barang`, `harga_return`, `jml_return`) VALUES
(1, 1, 1, 3000, 0),
(2, 1, 3, 6500, 3),
(3, 1, 2, 13000, 1);
...
--
-- Table structure for table `pembelian_terima`
--

CREATE TABLE `pembelian_terima` (
  `id_pembelian_terima` int(11) NOT NULL,
  `id_pembelian` int(11) NOT NULL,
...
--
-- Dumping data for table `pembelian_terima`
--

INSERT INTO `pembelian_terima` (`id_pembelian_terima`, `id_pembelian`, `no_pembelian_terima`, `no_surat_jalan`, `pengirim_barang`, `keterangan`, `tanggal_terima`, `id_karyawan`, `id_users`, `waktu_proses`) VALUES
(1, 1, 'TR-000001', 'JLN-001', 'Amaik Sapihi', 'Barang sampai dengan selamat,..', '2017-02-17', 2, 1, '2017-02-13 05:39:21');

-- --------------------------------------------------------

--
-- Table structure for table `pembelian_terima_detail`
--

CREATE TABLE `pembelian_terima_detail` (
...
--
-- Dumping data for table `pembelian_terima_detail`
--

INSERT INTO `pembelian_terima_detail` (`id_pembelian_terima_detail`, `id_pembelian_terima`, `id_barang`, `harga_pembelian`, `jml_terima`) VALUES
(1, 1, 1, 3000, 3),
(2, 1, 3, 6500, 7),
(3, 1, 2, 13000, 5);
...
--
-- Table structure for table `pendapatan_list`
--

CREATE TABLE `pendapatan_list` (
...
--
-- Dumping data for table `pendapatan_list`
--

INSERT INTO `pendapatan_list` (`id_pendapatan_list`, `id_pendapatan_sub`, `tanggal`, `jumlah_uang`, `keterangan`, `id_karyawan`, `waktu_proses`) VALUES
...
--
-- Table structure for table `pendapatan_main`
--

CREATE TABLE `pendapatan_main` (
  `id_pendapatan_main` int(11) NOT NULL,
  `nama_pendapatan_main` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pendapatan_main`
--

INSERT INTO `pendapatan_main` (`id_pendapatan_main`, `nama_pendapatan_main`) VALUES
(1, 'Penjualan'),
...
--
-- Table structure for table `pendapatan_sub`
--

CREATE TABLE `pendapatan_sub` (
  `id_pendapatan_sub` int(11) NOT NULL,
  `id_pendapatan_main` int(11) NOT NULL,
...
--
-- Dumping data for table `pendapatan_sub`
--

INSERT INTO `pendapatan_sub` (`id_pendapatan_sub`, `id_pendapatan_main`, `nama_pendapatan_sub`) VALUES
...
INSERT INTO `pendidikan` (`id_pendidikan`, `nama_pendidikan`, `id_users`) VALUES
(1, 'SMP', 1),
(2, 'SMA', 1),
(3, 'D3', 1),
(4, 'S1', 1);
...
INSERT INTO `penyesuaian` (`id_penyesuaian`, `id_sebab_alasan`, `tanggal_penyesuaian`, `keterangan`, `id_users`, `tanggal_proses`) VALUES
...
INSERT INTO `penyesuaian_detail` (`id_penyesuaian_detail`, `id_penyesuaian`, `id_barang`, `stok_history`, `tambah`, `kurang`, `keterangan`) VALUES
(1, 1, 3, 0, 5, 0, ''),
(2, 1, 2, 0, 10, 0, ''),
(3, 1, 1, 0, 15, 0, ''),
(6, 2, 1, 12, 0, 1, '');
...
INSERT INTO `promosi` (`id_promosi`, `tgl_mulai`, `tgl_selesai`, `kode_terapkan`, `id_kategori`, `id_subkategori`, `beli_barang`, `jml_beli`, `bonus_barang`, `jml_bonus`, `jenis_diskon`, `keterangan`, `id_users`, `waktu_promosi`) VALUES
...
--
-- Dumping data for table `promosi_detail`
--

INSERT INTO `promosi_detail` (`id_promosi_detail`, `id_promosi`, `id_kategori_pelanggan`, `ecer`, `grosir1`, `grosir2`, `grosir3`) VALUES
(1, 1, 1, 150, 0, 0, 0),
(2, 1, 2, 0, 0, 0, 0),
(3, 1, 3, 0, 0, 0, 0),
...
--
-- Table structure for table `promosi_terapkan`
--

CREATE TABLE `promosi_terapkan` (
  `kode_terapkan` varchar(50) NOT NULL,
  `keterangan` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `promosi_terapkan`
--

INSERT INTO `promosi_terapkan` (`kode_terapkan`, `keterangan`) VALUES
('barang', 'Barang'),
('kategori', 'Kategori'),
...
INSERT INTO `rak` (`id_rak`, `nama_rak`, `keterangan`, `id_users`) VALUES
(1, '1.1', 'Rak 1.1', 1),
(2, '1.2', 'Rak 1.2', 1),
(3, '2.1', 'Rak 2.1', 1);
...
INSERT INTO `satuan` (`kode_satuan`, `keterangan`, `id_users`) VALUES
('kodi', 'Kodi', 1),
('bh', 'Buah', 1),
('bks', 'Bungkus', 1),
('lsn', 'Lusin', 1);
...
--
-- Table structure for table `sebab_alasan`
--

CREATE TABLE `sebab_alasan` (
  `id_sebab_alasan` int(11) NOT NULL,
...
--
-- Dumping data for table `sebab_alasan`
--

INSERT INTO `sebab_alasan` (`id_sebab_alasan`, `nama_sebab_alasan`, `keterangan`, `id_users`) VALUES
...
INSERT INTO `state` (`state_id`, `country_id`, `name`, `id_users`) VALUES
(1, 1, 'Bali', 1),
(2, 1, 'Bengkulu', 1),
(3, 1, 'Banten', 1),
(4, 1, 'DIY', 1),
...
INSERT INTO `status_karyawan` (`id_status_karyawan`, `nama_status_karyawan`) VALUES
(1, 'Tetap'),
(2, 'Kontrak');
...
INSERT INTO `subkategori` (`id_subkategori`, `id_kategori`, `nama_subkategori`, `id_users`) VALUES
(1, 2, 'Dingin Banget', 1);
...
INSERT INTO `supplier` (`id_supplier`, `nama_supplier`, `kontak_person`, `alamat_1`, `alamat_2`, `city_id`, `state_id`, `country_id`, `telepon`, `hp`, `email`, `website`, `kode_pos`, `fax`, `chat`, `id_users`, `keterangan`) VALUES
...
INSERT INTO `tipe_diskon` (`tipe_diskon`, `keterangan`) VALUES
('persen', 'Persen (%)'),
('uang', 'Nominal (Rp)');
...
INSERT INTO `transaksi` (`id_transaksi`, `kode_transaksi`, `id_pelanggan`, `id_type_bayar`, `id_agen_ekspedisi`, `no_resi`, `biaya_kirim`, `diskon_persen`, `diskon_rupiah`, `diskon_belanja`, `gratis_kirim`, `jumlah_bayar`, `keterangan`, `status`, `id_karyawan`, `waktu_proses`) VALUES
...
INSERT INTO `transaksi_detail` (`id_transaksi_detail`, `id_transaksi`, `id_barang`, `jumlah_jual`, `kode_satuan`, `jumlah_satuan`, `diskon_jual`, `harga_jual`, `status`) VALUES
...
--
-- Table structure for table `transaksi_return_detail`
--

CREATE TABLE `transaksi_return_detail` (
...
INSERT INTO `type_bayar` (`id_type_bayar`, `nama_type_bayar`) VALUES
(1, 'Cash (Tunai)'),
(2, 'Transfer'),
(3, 'Cheque (Cek)'),
(4, 'Debet (Kartu Debit)'),
...
--
-- Table structure for table `type_pelanggan`
--

CREATE TABLE `type_pelanggan` (
  `id_type_pelanggan` int(11) NOT NULL,
...
--
-- Dumping data for table `type_pelanggan`
--

INSERT INTO `type_pelanggan` (`id_type_pelanggan`, `type_pelanggan`, `id_users`) VALUES
(1, 'Perorangan', 1),
(2, 'Badan Usaha', 1);
...
--
-- Indexes for table `barang_jenis_jual`
--
ALTER TABLE `barang_jenis_jual`
  ADD PRIMARY KEY (`id_barang_jenis_jual`);

--
-- Indexes for table `bebanbiaya_list`
--
ALTER TABLE `bebanbiaya_list`
  ADD PRIMARY KEY (`id_bebanbiaya_list`);

--
-- Indexes for table `bebanbiaya_main`
--
ALTER TABLE `bebanbiaya_main`
  ADD PRIMARY KEY (`id_bebanbiaya_main`);

--
-- Indexes for table `bebanbiaya_sub`
--
ALTER TABLE `bebanbiaya_sub`
...
--
-- Indexes for table `conf_barang`
--
ALTER TABLE `conf_barang`
  ADD PRIMARY KEY (`id_conf_barang`);

--
-- Indexes for table `conf_penjualan`
--
ALTER TABLE `conf_penjualan`
  ADD PRIMARY KEY (`id_conf_penjualan`);

--
-- Indexes for table `conf_perusahaan`
--
ALTER TABLE `conf_perusahaan`
...
--
-- Indexes for table `pelanggan_piutang`
--
ALTER TABLE `pelanggan_piutang`
...
--
-- Indexes for table `pembelian_return`
--
ALTER TABLE `pembelian_return`
  ADD PRIMARY KEY (`id_pembelian_return`);

--
-- Indexes for table `pembelian_return_detail`
--
ALTER TABLE `pembelian_return_detail`
  ADD PRIMARY KEY (`id_pembelian_return_detail`);

--
-- Indexes for table `pembelian_terima`
--
ALTER TABLE `pembelian_terima`
  ADD PRIMARY KEY (`id_pembelian_terima`);

--
-- Indexes for table `pembelian_terima_detail`
--
ALTER TABLE `pembelian_terima_detail`
  ADD PRIMARY KEY (`id_pembelian_terima_detail`);

--
-- Indexes for table `pendapatan_list`
--
ALTER TABLE `pendapatan_list`
  ADD PRIMARY KEY (`id_pendapatan_list`);

--
-- Indexes for table `pendapatan_main`
--
ALTER TABLE `pendapatan_main`
  ADD PRIMARY KEY (`id_pendapatan_main`);

--
-- Indexes for table `pendapatan_sub`
--
ALTER TABLE `pendapatan_sub`
...
--
-- Indexes for table `promosi_terapkan`
--
ALTER TABLE `promosi_terapkan`
...
--
-- Indexes for table `sebab_alasan`
--
ALTER TABLE `sebab_alasan`
...
--
-- Indexes for table `transaksi_return_detail`
--
ALTER TABLE `transaksi_return_detail`
...
--
-- Indexes for table `type_pelanggan`
--
ALTER TABLE `type_pelanggan`
...
--
-- AUTO_INCREMENT for table `agen_ekspedisi`
--
ALTER TABLE `agen_ekspedisi`
...
--
-- AUTO_INCREMENT for table `pelanggan_piutang`
--
ALTER TABLE `pelanggan_piutang`
...
--
-- AUTO_INCREMENT for table `sebab_alasan`
--
ALTER TABLE `sebab_alasan`
...
--
-- AUTO_INCREMENT for table `transaksi_return_detail`
--
ALTER TABLE `transaksi_return_detail`
...
--
-- AUTO_INCREMENT for table `type_pelanggan`
--
ALTER TABLE `type_pelanggan`
