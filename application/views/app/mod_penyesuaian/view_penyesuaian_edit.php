<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('app/edit_penyesuaian',$attributes); 
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$row[id_penyesuaian]'>
                  ...
                  <table class='table table-bordered table-striped'>
                      <thead>
                        ...
                        <tr>
                          <td></td>
                          <td><select name='d' class='combobox form-control' onchange=\"changeValue(this.value)\" autofocus>
                        ...
                        $no = 1;
                        $penyesuaian_detail = $this->db->query("SELECT * FROM penyesuaian_detail a JOIN barang b ON a.id_barang=b.id_barang where a.id_penyesuaian='".$this->uri->segment(3)."' ORDER BY a.id_penyesuaian_detail DESC");
                        foreach ($penyesuaian_detail->result_array() as $r){
                          echo "<tr>
                                ...
                                <td>$r[kurang]</td>
                                <td>$r[keterangan]</td>
                                <td align=center><a class='text-danger' title='Delete Data' href='".base_url()."app/delete_penyesuaian_detail/".$this->uri->segment(3)."/$r[id_penyesuaian_detail]/$r[tambah]/$r[kurang]/$r[id_barang]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a></td>
                              </tr>";
                          $no++;
                        }
                      echo "</thead>
