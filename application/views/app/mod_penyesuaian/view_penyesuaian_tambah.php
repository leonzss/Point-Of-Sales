          ...
          echo "<div class='col-md-12'>
                  ...
                  <table class='table table-bordered table-striped'>
                      <thead>
                        ...
                        $no = 1;
                        $penyesuaian_detail = $this->db->query("SELECT * FROM penyesuaian_detail a JOIN barang b ON a.id_barang=b.id_barang where a.id_penyesuaian='".$this->session->id_penyesuaian."' ORDER BY a.id_penyesuaian_detail DESC");
