<?php 
$tot = $this->db->query("SELECT sum((jumlah_jual*harga_jual)-diskon_jual) as subtotal FROM `transaksi_detail` where id_transaksi='".$this->session->id_transaksi."' AND status='1'")->row_array();
