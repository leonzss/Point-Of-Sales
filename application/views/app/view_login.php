...
<html>
  ...
  <body class="hold-transition login-page" style="background-image: url('asset/images/bg.jpg'); background-repeat: no-repeat; background-size: 100% 100%;">
    <div class="login-box">
      <div class="login-logo">
        <a href="#">LOKOPOS<br/><b>POINT</b> of <b>SALES</b></a>
      </div><!-- /.login-logo -->
