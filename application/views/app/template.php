...
<html>
  <head>
    ...
    <title>Selamat Datang Di Aplikasi Penjualan</title>
    <meta name="author" content="lokomedia">
    ...
    <script src="<?php echo base_url(''); ?>asset/js/loko.js"></script>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <?php $row = $this->model_app->view_one_address('conf_perusahaan',array('id_perusahaan' => 1),'id_perusahaan')->row_array(); ?>
    <div class="wrapper">
