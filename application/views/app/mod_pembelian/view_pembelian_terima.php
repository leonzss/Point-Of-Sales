...
$kode_terima = "TR-".sprintf("%06s", $kode->id_pembelian_terima+1);
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('app/terima_pembelian',$attributes); 
                ...
                $tgltrm = $this->db->query("SELECT GROUP_CONCAT(DATE_FORMAT(tanggal_terima, '%d/%m/%Y') SEPARATOR ', ') as tanggal  FROM `pembelian_terima` where id_pembelian='".$this->uri->segment(3)."'")->row_array();
                ...
                <table class='table table-bordered table-striped'>
                      ...
                      <tbody>";
                        ...
                        foreach ($penyesuaian_detail->result_array() as $r){
                          ...
                          $trm = $this->db->query("SELECT sum(a.jml_terima) as terima FROM `pembelian_terima_detail` a JOIN pembelian_terima b ON a.id_pembelian_terima=b.id_pembelian_terima where b.id_pembelian='".$this->uri->segment(3)."' AND a.id_barang='".$r['id_barang']."'")->row_array();
