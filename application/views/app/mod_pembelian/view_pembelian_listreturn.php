              ...
              <div class="box">
                ...
                <?php
                  echo "<table id='example1' class='table table-bordered table-striped table-condensed'>
                    ...
                    $rows = $this->db->query("SELECT sum(harga_return*jml_return) as jml_bayar FROM pembelian_return_detail where id_pembelian_return='$row[id_pembelian_return]'")->row_array();
                    echo "<tr><td>$no</td>
                              <td>$row[no_return]</td>
