          ...
          echo "<h2><center>PURCHASE RETURN</center></h2>
                ...
                <table id='tablemodul1' width='100%' border='1'>
                      ...
                      <tbody>";
                        ...
                        $no = 1;
                        $penyesuaian_detail = $this->db->query("SELECT * FROM pembelian_return_detail a JOIN barang b ON a.id_barang=b.id_barang where a.id_pembelian_return='".$this->uri->segment(3)."' ORDER BY a.id_pembelian_return_detail DESC");
                        ...
                        $tot = $this->db->query("SELECT sum(jml_return) as jml, sum(harga_return*jml_return) as total FROM `pembelian_return_detail` where id_pembelian_return='".$this->uri->segment(3)."'")->row_array();
                      echo "</tbody>
