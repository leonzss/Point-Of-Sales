                ...
                <table class='table table-bordered table-striped'>
                      ...
                      <tbody>";
                        ...
                        foreach ($penyesuaian_detail->result_array() as $r){
                          ...
                          $terima = $this->db->query("SELECT sum(a.jml_terima) as jml_terima, b.id_pembelian, a.* FROM pembelian_terima_detail a JOIN pembelian_terima b ON a.id_pembelian_terima=b.id_pembelian_terima where a.id_barang='$r[id_barang]' AND b.id_pembelian='$row[id_pembelian]'")->row_array();
