          ...
          echo "<div class='col-md-6'>
                ...
                <table class='table table-bordered table-striped'>
                      ...
                      <tbody>";
                        ...
                        $no = 1;
                        $penyesuaian_detail = $this->db->query("SELECT * FROM pembelian_detail a JOIN barang b ON a.id_barang=b.id_barang where a.id_pembelian='".$this->session->id_pembelian."' ORDER BY a.id_pembelian_detail DESC");
                        ...
                        $tot = $this->db->query("SELECT sum(jml_pesan*harga_pesan) as tharga, sum(jml_pesan) as tjumlah FROM `pembelian_detail` where id_pembelian='".$this->session->id_pembelian."'")->row_array();
                      echo "</tbody>
