            <div class="col-xs-12">  
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php 
                    $no = 1;
                    $perkiraan = $this->db->query("SELECT id_pendapatan_main as id, nama_pendapatan_main as nama_perkiraan, 1 as status FROM `pendapatan_main` UNION SELECT id_bebanbiaya_main as id, nama_bebanbiaya_main as nama_perkiraan, 2 as status FROM `bebanbiaya_main`");
                    foreach ($perkiraan->result_array() as $row){
                    echo "<tr><td>$no</td>
                              <td><b>$row[nama_perkiraan]</b></td>
                          </tr>";
                          if ($row['status']=='1'){ $table = 'pendapatan_sub'; $field0 = 'id_pendapatan_sub'; $field = 'nama_pendapatan_sub'; $id = 'id_pendapatan_main'; }else{ $table = 'bebanbiaya_sub'; $field0 = 'id_bebanbiaya_sub'; $field = 'nama_bebanbiaya_sub'; $id = 'id_bebanbiaya_main'; }
