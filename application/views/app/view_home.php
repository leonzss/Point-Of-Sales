  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <?php $jmla = $this->db->query("SELECT * FROM transaksi where status='selesai'")->num_rows(); ?>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <?php $jmlb = $this->db->query("SELECT * FROM pembelian")->num_rows(); ?>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <?php $jmlc = $this->db->query("SELECT * FROM barang")->num_rows(); ?>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <?php $jmld = $this->db->query("SELECT * FROM pelanggan")->num_rows(); ?>
...
<?php 
$users = $this->model_app->edit('karyawan', array('id_karyawan' => $this->session->id_users))->row_array();
