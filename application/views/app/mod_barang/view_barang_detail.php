                ...
                <div class='col-md-12'>
                  ...
                  <tbody>";
                    ...
                    foreach ($kategori_pelanggan as $r) {
                      ...
                      $harga1 = $this->model_app->view_one('barang_harga',array('id_barang'=>$row['id_barang'], 'id_kategori_pelanggan'=>$id, 'id_jenis_jual'=>'1'),'id_barang_harga')->row_array();
                      $harga2 = $this->model_app->view_one('barang_harga',array('id_barang'=>$row['id_barang'], 'id_kategori_pelanggan'=>$id, 'id_jenis_jual'=>'2'),'id_barang_harga')->row_array();
                      $harga3 = $this->model_app->view_one('barang_harga',array('id_barang'=>$row['id_barang'], 'id_kategori_pelanggan'=>$id, 'id_jenis_jual'=>'3'),'id_barang_harga')->row_array();
                      $harga4 = $this->model_app->view_one('barang_harga',array('id_barang'=>$row['id_barang'], 'id_kategori_pelanggan'=>$id, 'id_jenis_jual'=>'4'),'id_barang_harga')->row_array();
                      $permanen = $r['permanen'];
                      if ($r['permanen']=='y'){
                        $visible = 'visible';
                      }else{
