<?php 
    echo "<div class='col-md-12'>
              ...
              $pelanggan = $this->db->query("SELECT * FROM kategori_pelanggan where id_kategori_pelanggan='$row[id_kategori_pelanggan]'")->row_array();
              $kategori = $this->db->query("SELECT * FROM type_pelanggan where id_type_pelanggan='$row[id_type_pelanggan]'")->row_array();
              
              $negara = $this->db->query("SELECT * FROM country where country_id='$row[country_id]'")->row_array();
              $provinsi = $this->db->query("SELECT * FROM state where state_id='$row[state_id]'")->row_array();
              $kota = $this->db->query("SELECT * FROM city where city_id='$row[city_id]'")->row_array();
